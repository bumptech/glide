...
// Manually implements Parcelable to bypass compiler plugin deadlocks/unresolved
// reference issues between kotlin-parcelize and AGP 9.0's built-in Kotlin compiler support.
