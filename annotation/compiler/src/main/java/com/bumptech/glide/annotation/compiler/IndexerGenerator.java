 ...
 * ChildGlideModules and/or one or more GlideExtensions.
 *
 * <p>We use a separate class so that ChildGlideModules and GlideExtensions written in libraries can
 * be bundled into an AAR and later retrieved by the annotation processor when it processes the
 * RootGlideModule in an application.
 *
 * <p>The output file generated by this class with a ChildGlideModule looks like this:
 * <pre>
 * <code>
 *  {@literal @com.bumptech.glide.annotation.compiler.Index(}
 *      modules = "com.bumptech.glide.integration.okhttp3.OkHttpChildGlideModule"
 *  )
 *  public class Indexer_GlideModule_com_bumptech_glide_integration_okhttp3_OkHttpChildGlideModule {
 *  }
 * </code>
 * </pre>
 *
...
final class IndexerGenerator {
  ...
  private static TypeSpec generate(List<TypeElement> childModules,
