 ...
 * <ul>
 *   <lcode>For {@code LibraryGlideModule}s - A GlideIndexer class in a
...
public final class GlideAnnotationProcessor extends AbstractProcessor {
   ...
   *   <li>For each {@code LibraryGlideModule}, write an Indexer with an Annotation with the class name.
