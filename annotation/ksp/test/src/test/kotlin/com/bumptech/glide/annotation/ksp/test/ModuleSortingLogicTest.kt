...
/**
 * Tests that module sorting by qualified name works correctly and deterministically. This ensures
 * reproducible builds across KSP versions.
 */
...
class ModuleSortingLogicTest {
  ...
  fun sortByQualifiedName_withSimilarNames_sortsCorrectly() {
    ...
    assertThat(sorted)
      .containsExactly("MyModule", "MyModule2", "MyModuleA", "MyModuleExt")
      .inOrder()
  }
  ...
  fun sortByQualifiedName_withSpecialCharacters_sortsCorrectly() {
    ...
    val modules =
      listOf("com.test.Module_V2", "com.test.Module_V1", "com.test.Module2", "com.test.Module1")
