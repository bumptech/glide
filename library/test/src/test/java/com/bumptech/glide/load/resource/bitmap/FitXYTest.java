...
public class FitXYTest {
  ...
  public void testDoesNotPutNullBitmapAcquiredFromPool() {
    ...
    fitXY.transform(context, resource, 100, 100);
  ...
  public void testReturnsGivenResourceIfMatchesSizeExactly() {
    Resource<Bitmap> result = fitXY.transform(context, resource, bitmapWidth, bitmapHeight);
  ...
  public void testDoesNotRecycleGivenResourceIfMatchesSizeExactly() {
    fitXY.transform(context, resource, bitmapWidth, bitmapHeight);
  ...
  public void testDoesNotRecycleGivenResource() {
    fitXY.transform(context, resource, 50, 50);
  ...
  public void testAsksBitmapPoolForArgb8888IfInConfigIsNull() {
    ...
    fitXY.transform(context, resource, 10, 10);
  ...
  public void testReturnsBitmapWithExactlyGivenDimensionsIfBitmapIsLargerThanTarget() {
    ...
    for (int[] dimens :
      ...
      Resource<Bitmap> result =
          fitXY.transform(context, resource, expectedWidth, expectedHeight);
  ...
  public void testEquals() {
    ...
    keyTester
        .addEquivalenceGroup(new FitXY(), new FitXY())
        .addEquivalenceGroup(transformation)
        .addRegressionTest(
            new FitXY(), "00a988817b92f984a54a5921ffc73472c43262a09b6a3e37ca4c43b45b0ca653")
        .test();
  }
}
