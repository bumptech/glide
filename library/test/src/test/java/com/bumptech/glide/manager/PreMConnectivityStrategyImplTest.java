...
import com.bumptech.glide.manager.PreMConnectivityStrategyImplTest.PermissionConnectivityManager;
...
public class PreMConnectivityStrategyImplTest {
  @Mock private ConnectivityMonitor.ConnectivityListener listener;
  private PreMConnectivityStrategyImpl monitor;
  private ConnectivityHarness harness;

  @Before
  public void setUp() {
    MockitoAnnotations.initMocks(this);
    monitor = new PreMConnectivityStrategyImpl(RuntimeEnvironment.application, listener);
