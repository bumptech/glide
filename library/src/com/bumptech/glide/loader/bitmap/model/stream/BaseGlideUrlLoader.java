...
public abstract class BaseGlideUrlLoader<T> implements StreamModelLoader<T> {
    ...
    private final Cache<GlideUrl> modelCache;

    public BaseGlideUrlLoader(Context context) {
        this(context, null);
    }

    public BaseGlideUrlLoader(Context context, Cache<GlideUrl> modelCache) {
    ...
    public BaseGlideUrlLoader(ModelLoader<GlideUrl, InputStream> concreteLoader, Cache<GlideUrl> modelCache) {
