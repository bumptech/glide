 ...
 * URL, call {@link #toURL()} and then {@link java.net.URL#toString()}. </p>
 */
public class GlideUrl {
  ...
  // using URI would work,
  // using it would require both decoding and encoding each string which is more complicated,
  // slower and generates
