...
public class StreamBitmapDecoder implements ResourceDecoder<InputStream, Bitmap> {
    ...
    @Override
    public Resource<Bitmap> decode(InputStream source, int width, int height, Map<String, Object> options) {
        DownsampleStrategy strategy = options.containsKey(KEY_DOWNSAMPLE_STRATEGY)
