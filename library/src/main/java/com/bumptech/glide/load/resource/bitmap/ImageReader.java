...
interface ImageReader {
  ...
  final class ParcelFileDescriptorImageReader implements ImageReader {
    ...
    public ImageHeaderParser.ImageType getImageType() throws IOException {
      ...
      // dataRewinder.
      InputStream is = new RewindableInputStream(dataRewinder);
      try {
    ...
    private static final class RewindableInputStream extends FileInputStream {

      private final ParcelFileDescriptorRewinder dataRewinder;

      RewindableInputStream(ParcelFileDescriptorRewinder dataRewinder) throws IOException {
        super(dataRewinder.rewindAndGet().getFileDescriptor());

        this.dataRewinder = dataRewinder;
      }
