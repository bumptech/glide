...
public interface ModelLoader<T, Y> {
     ...
     *
     * <p>
     *     Note - If the {@link com.bumptech.glide.load.data.DataFetcher} in any way retains a reference a context,
     *     either directly or as an anonymous inner class, that context may be leaked. The leak will only be an issue
     *     if this load can run for a long time or indefinitely (because of a particularly slow or paused/failed
