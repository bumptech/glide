...
/**
 * An {@link com.bumptech.glide.load.resource.bitmap.BitmapDecoder} that can decode a thumbnail
 * frame {@link Bitmap} from a {@link android.os.ParcelFileDescriptor} containing a video.
 *
...
public class VideoBitmapDecoder implements BitmapDecoder<ParcelFileDescriptor> {
  ...
  @Override
  public Bitmap decode(ParcelFileDescriptor resource, BitmapPool bitmapPool, int outWidth,
      int outHeight, Map<String, Object> options) throws IOException {
    int frame = options.containsKey(KEY_TARGET_FRAME) ? (Integer) options.get(KEY_TARGET_FRAME)
        : DEFAULT_FRAME;
