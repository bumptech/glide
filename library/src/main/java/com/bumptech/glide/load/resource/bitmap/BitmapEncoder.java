...
public class BitmapEncoder implements ResourceEncoder<Bitmap> {
    ...
    /**
     * A key for an {@link android.graphics.Bitmap.CompressFormat} option used as the format to encode the
     * {@link android.graphics.Bitmap}.
     *
     * <p>
     *     Defaults to {@link android.graphics.Bitmap.CompressFormat#JPEG} for images without alpha and
    ...
    private int getQuality(Map<String, Object> options) {
        ...
        Preconditions.checkArgument(quality == null || quality >= 0 && quality <= 100, "quality must be between 0 and"
                + " 100, given: " + quality);
