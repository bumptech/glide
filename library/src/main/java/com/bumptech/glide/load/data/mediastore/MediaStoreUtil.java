...
public final class MediaStoreUtil {
  ...
  @ChecksSdkIntAtLeast(api = 17, extension = VERSION_CODES.R)
  public static boolean isMediaStoreOpenFileAPIsAvailable() {
    return Build.VERSION.SDK_INT >= Build.VERSION_CODES.R
        && SdkExtensions.getExtensionVersion(Build.VERSION_CODES.R) >= 17;
  }

  @RequiresExtension(extension = VERSION_CODES.R, version = 17)
