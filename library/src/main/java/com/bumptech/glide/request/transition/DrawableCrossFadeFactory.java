 ...
 *     typically does not expect to see a transition. As a result, when the resource is loaded from the memory
 *     cache this factory produces an {@link NoTransition}.
 * </p>
 */
public class DrawableCrossFadeFactory implements TransitionFactory<Drawable> {
    ...
    private static class DefaultViewTransitionAnimationFactory
