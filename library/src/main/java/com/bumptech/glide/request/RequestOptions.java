 ...
 *
 * <p>
 *     Uses with custom types, transformations, or options can subclass and customize.
...
public class RequestOptions extends BaseRequestOptions<RequestOptions> {
    ...
    public static RequestOptions bitmapTransform(Context context, Transformation<Bitmap> transformation) {
