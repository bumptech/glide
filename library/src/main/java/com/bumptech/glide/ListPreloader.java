...
public class ListPreloader<T> implements AbsListView.OnScrollListener {
  ...
  /**
   * Constructor for {@link com.bumptech.glide.ListPreloader} that requires users to subclass and
   * override the {@link #getItems(int, int)} and {@link #getRequestBuilder(Object)} methods.
   *
   ...
   * com.bumptech.glide.ListPreloader.PreloadSizeProvider, int)} instead. This constructor will be
   ...
   *
   * <p> Note - The size returned here must precisely match those of the view in the list. </p>
   *
   * @param item A model
   * @return The size of the view where the item will be displayed
   * @deprecated Use {@link com.bumptech.glide.ListPreloader.PreloadSizeProvider} instead. This
   * method will be removed in Glide 4.0.
   */
  @Deprecated
  ...
  /**
   * Returns a non null list of all models that need to be loaded for the list to display adapter
   * items between {@code start} and {@code end}.
   *
   * <p> A list of any size can be returned so there can be multiple models per adapter position.
   * </p>
   *
   ...
   *              start}
   * @deprecated Use {@link com.bumptech.glide.ListPreloader.PreloadModelProvider} instead. This
   * method will be removed in Glide 4.0.
   */
  @Deprecated
  ...
  /**
   * Returns a non null {@link RequestBuilder} for a given item. Must exactly match the request used
   * to load the resource in the list.
   *
   * <p> The target and context will be provided by the preloader. </p>
   *
   * @param item The model to load.
