...
public class ListPreloader<T> implements AbsListView.OnScrollListener {
  ...
  public interface PreloadModelProvider<U> {
     ...
     *
     * <p>{@code position} is the position in the view. If the view contains a mix of types
     * (e.g. headers and images) then not every view position will actually have any model to return
     * here. If that's the case for the given {@code position}, then return an empty list.
     *
