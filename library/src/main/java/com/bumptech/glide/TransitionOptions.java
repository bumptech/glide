...
public abstract class TransitionOptions<CHILD extends TransitionOptions<CHILD, TranscodeType>, TranscodeType>
    ...
    /**
     * Sets a {@link android.view.animation} to run on the wrapped target when an resource load finishes. Will only be
     * run if the resource was loaded asynchronously (ie was not in the memory cache)
     *
     * @param viewAnimationId The resource id of the {@link android.view.animation} to use as the transition.
     * @return This request builder.
     */
     ...
     * memory cache).
     *
     * @param animator The {@link com.bumptech.glide.request.transition.ViewPropertyTransition.Animator} to run.
     * @return This request builder.
     */
