...
public class Registry {
    ...
    public <Resource> Registry register(Class<Resource> resourceClass, ResourceEncoder<Resource> encoder) {
    ...
    public <Resource, Transcode> Registry register(Class<Resource> resourceClass, Class<Transcode> transcodeClass,
            ResourceTranscoder<Resource, Transcode> transcoder) {
        transcoderRegistry.register(resourceClass, transcodeClass, transcoder);
        return this;
    }

    /**
     * Use the given factory to build a {@link com.bumptech.glide.load.model.ModelLoader} for models of the given class.
     * Generally the best use of this method is to replace one of the default factories or add an implementation for
     * other similar low level models. Any factory replaced by the given factory will have its
