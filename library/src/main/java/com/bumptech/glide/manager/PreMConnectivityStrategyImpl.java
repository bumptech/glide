...
/**
 * a {@link com.bumptech.glide.manager.ConnectivityStrategy} implementation that use {@link
 * BroadcastReceiver} to perceive connectivity changes.
 */
public class PreMConnectivityStrategyImpl implements ConnectivityStrategy {
  ...
  PreMConnectivityStrategyImpl(@NonNull Context context, @NonNull ConnectivityListener listener) {
