...
public class GlideContext extends ContextWrapper implements ComponentCallbacks2 {
  ...
  public <DataType, ResourceType, TranscodeType> LoadPath<DataType, ResourceType, TranscodeType>
  getLoadPath(
  ...
  private <DataType, ResourceType, TranscodeType> List<DecodePath<DataType, ResourceType,
      TranscodeType>> getDecodePaths(
      Class<DataType> dataClass, Class<ResourceType> resourceClass,
      Class<TranscodeType> transcodeClass) {
    List<DecodePath<DataType, ResourceType, TranscodeType>> decodePaths = new ArrayList<>();
  ...
  public <X> ResourceEncoder<X> getResultEncoder(Resource<X> resource)
    ...
    ResourceEncoder<X> resourceEncoder =
        (ResourceEncoder<X>) registry.resourceEncoderRegistry.get(resource.get().getClass());
  ...
  public <X, Y> ResourceTranscoder<X, Y> getTranscoder(Class<X> resourceClass,
      Class<Y> transcodeClass) {
