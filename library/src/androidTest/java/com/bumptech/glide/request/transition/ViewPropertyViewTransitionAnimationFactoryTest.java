...
public class ViewPropertyViewTransitionAnimationFactoryTest {
    ...
    public void testReturnsNoAnimationIfFromMemoryCache() {
        assertEquals(NoTransition.get(), factory.build(true /*isFromMemoryCache*/, true /*isFirstResource*/));
    }

    @Test
    public void testReturnsNoAnimationIfNotFirstResource() {
        assertEquals(NoTransition.get(), factory.build(false /*isFromMemoryCache*/, false /*isFirstResource*/));
    }

    @Test
    public void testReturnsAnimationIfNotFromMemoryCacheAndFirstResource() {
        assertNotEquals(NoTransition.get(), factory.build(false /*isFromMemoryCache*/, true /*isFirstResource*/));
    }
}