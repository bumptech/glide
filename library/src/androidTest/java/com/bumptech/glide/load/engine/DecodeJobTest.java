...
//
//  @Test
//  public void testOriginalResourceIsRecycledIfDifferentThanTransformedResource()
// throws Exception {
//    for (DiskCacheStrategy strategy : list(DiskCacheStrategy.ALL, DiskCacheStrategy.DATA)) {
//      harness = new Harness(strategy);
//
...
//
//  @Test(expected = RuntimeException.class)
//  public void testThrowsIfTransformationOfResourceDecodedFromCachedSourceThrows()
// throws Exception {
//    harness.diskCacheStrategy = DiskCacheStrategy.ALL;
//    mockCacheToReturnSourceResource();
//    when(harness.transformation.transform(any(Resource.class), anyInt(), anyInt()))
...
//      harness.getJob().decodeFromSource();
//
//      verify(harness.diskCache, never()).put(eq(harness.originalKey),
// any(DiskCache.Writer.class));
//    }
//  }
//
//  @Test
//  public void testTransformedResourceDecodedFromSourceIsWrittenToCacheIfCacheStrategyResult()
//      throws Exception {
//    for (DiskCacheStrategy strategy : list(DiskCacheStrategy.ALL, DiskCacheStrategy.RESOURCE)) {
//      harness = new Harness(strategy);
//
...
//
//  @Test
//  public void testResourceDecodedFromSourceDataIsNotRecycledIfSameAsTransformed()
// throws Exception {
//    for (DiskCacheStrategy strategy : DiskCacheStrategy.values()) {
//      harness = new Harness(strategy);
//      mockSourceToReturnResource();
