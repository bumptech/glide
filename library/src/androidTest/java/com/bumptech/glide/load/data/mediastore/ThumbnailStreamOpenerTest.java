...
public class ThumbnailStreamOpenerTest {
    ...
    public void testReturnsNullIfCursorIsNull() throws FileNotFoundException {
        ...
        assertNull(harness.get()
                .open(RuntimeEnvironment.application, harness.uri));
    }

    @Test
    public void testReturnsNullIfCursorIsEmpty() throws FileNotFoundException {
        when(harness.query.query(eq(RuntimeEnvironment.application), eq(harness.uri))).thenReturn(
    ...
    public void testReturnsNullIfCursorHasEmptyPath() throws FileNotFoundException {
        ...
        when(harness.query.query(eq(RuntimeEnvironment.application), eq(harness.uri))).thenReturn(cursor);
        assertNull(harness.get()
                .open(RuntimeEnvironment.application, harness.uri));
    }
    ...
    public void testReturnsOpenedInputStreamWhenFileFound() throws FileNotFoundException {
        ...
        Shadows.shadowOf(RuntimeEnvironment.application.getContentResolver()).registerInputStream(harness.uri,
                expected);
    ...
    public void testVideoQueryReturnsVideoCursor() {
        ...
        Shadows.shadowOf(RuntimeEnvironment.application.getContentResolver()).setCursor(queryUri, testCursor);
