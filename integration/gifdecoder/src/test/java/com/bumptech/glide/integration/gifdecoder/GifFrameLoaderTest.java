...
import com.bumptech.glide.integration.gifdecoder.GifFrameLoader.DelayTarget;
import com.bumptech.glide.integration.gifdecoder.GifFrameLoader.FrameCallback;
import com.bumptech.glide.load.Transformation;
import com.bumptech.glide.request.Request;
import com.bumptech.glide.request.RequestOptions;
import com.bumptech.glide.request.target.Target;
import com.bumptech.glide.testlib.Util.ReturnsSelfAnswer;
...
public class GifFrameLoaderTest {
  ...
  public void setUp() {
    ...
    when(handler.obtainMessage(anyInt(), isA(DelayTarget.class)))
  ...
  public void testOnFrameReadyClearsPreviousFrame() {
    ...
    when(previous.getResource())
        .thenReturn(Bitmap.createBitmap(100, 100, Bitmap.Config.ARGB_8888));

    DelayTarget current = mock(DelayTarget.class);
    when(current.getResource())
        .thenReturn(Bitmap.createBitmap(100, 100, Bitmap.Config.RGB_565));
