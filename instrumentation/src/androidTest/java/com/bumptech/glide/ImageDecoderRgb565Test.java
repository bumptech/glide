...
public class ImageDecoderRgb565Test {
  ...
  @Test
  public void loadBmpResource_fallsBackToDownsampler() {
  ...
  public void loadBmpResource_withPreferRgb565AndForceFallback_returnsRgb565Config() {
    initGlideForImageDecoder(
        ResourceIds.raw.canonical_bmp, /* enableRgb565Fix= */ true, /* poolBitmap= */ null);
  ...
  private void initGlideForImageDecoder(
    ...
    Glide.init(
        ...
        new GlideBuilder()
            ...
            .setUriImageDecoderEnabled(true)
            .setUseHeapBufferForImageDecoderWithInputStream(true)
