...
/**
 * A fake {@link ModelLoader} and {@link ModelLoaderFactory} that loads an {@link InputStream} for a
 * given Android resource ID regardless of the model object provided.
 */
public class FakeStreamModelLoader<T>
  ...
  /** Reads the raw bytes of the given resource ID. */
